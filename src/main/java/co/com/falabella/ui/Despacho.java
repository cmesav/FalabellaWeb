...
public class Despacho {
    ...
    public static final Target DIRECCION = Target.the("Direccion")
        ...
        public static final Target BOTON_INGRESAR_DIRECCION = Target.the("Boton ingresar")
            .located(By.className("fbra_button fbra_test_button fbra_formItem__useAddress"));

        public static final Target CAMPO_DESPLEGABLE = Target.the("Informacion adicional despacho")
            .located(By.className("fbra_deliveryInstructions__collapsibleBody_label"));
    ...
    public static final Target BOTON_CONTINUAR = Target.the("Informacion adicional despacho")
            .located(By.className("fbra_button fbra_checkoutComponentDeliveryActions__continueToSecurePaymentButton fbra_test_checkoutComponentDeliveryActions__continueToSecurePaymentButton"));
